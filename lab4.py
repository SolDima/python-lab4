...
# Наступні функції split join tartswith
...
# Наступні функції lower find title 
...
# Наступні функції strip replace isalpha
...
# Наступні функції capitalize endswith swapcase
